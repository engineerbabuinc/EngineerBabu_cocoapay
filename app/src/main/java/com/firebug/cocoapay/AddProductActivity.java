	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addProductButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				//startActivity(new Intent(AddProductActivity.this,SignatureActivity.class));
				//code changed by himanshu
				startActivity(new Intent(AddProductActivity.this,Edit_Product_Activity.class));

			}
		});
		addPricePointImageView.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(new Intent(AddProductActivity.this,PricePointsActivity.class));
			}
		});
