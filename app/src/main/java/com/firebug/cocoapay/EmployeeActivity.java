...
import com.firebug.cocoapay.adapter.EmployeeAdapter;
...
public class EmployeeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < 5; i++) {
			EmployeeInfo items = new EmployeeInfo();
			items.setEmployeeName("Pranav");
			arrayList.add(items);
		}
		EmployeeAdapter adapter = new EmployeeAdapter(EmployeeActivity.this,
				R.layout.employee_list_item, arrayList);
	...
	public void customactionBar() {
		...
		titleTextView.setText("Employees");
