...
public class Validation {
	...
	public static boolean isEmailAddress(AutoCompleteTextView editText,
			boolean required, String msg) {
		return isValid(editText, EMAIL_REGEX, EMAIL_MSG, required, msg);
	}
	...
	public static boolean isPhoneNumber(AutoCompleteTextView editText,
			boolean required, String msg) {
		return isValid(editText, PHONE_REGEX, PHONE_MSG, required, msg);
	}
